$(document).ready(function(){
	...
	$("body").delegate(".btn-check", "click", function(){
		...
		myAsyncAjaxAppend("#sr_content","/ssm_wechat/goods/goodsIndex.do",{"method":$('.choose').attr("data-val"),"name":name,"typeIds":type,"curPage":curPage},"page","goods/goods_index.html#ajaxBDyunList",$(this));
		$(this).remove();
		});
	...
	$("#sr_btn_search").click(function(){
		...
		/*var instituteId = $("#condition_instituteId").val();*/
		 ...
		 myAsyncAjax("#sr_content","/ssm_wechat/goods/goodsIndex.do",{"method":$('.choose').attr("data-val"),"name":name,"typeIds":type},"page","goods/goods_index.html#ajaxBDyunList");
...
/*		$("[name = goods_goodsStype]:checkbox").children("div").children("span").removeClass("border_1_solid");
	...
	/*$("body").delegate("#div_label_content .div_lebel", "click", function(){*/
		...
		var name = $("#sr_condition_name").val();
		/*var instituteId = $("#condition_instituteId").val();*/
		myAjax("#sr_content","/ssm_wechat/goods/goodsIndex.do",{"method":$('.choose').attr("data-val"),"name":name,"typeIds":type},"page","goods/goods_index.html#ajaxBDyunList");
	});
